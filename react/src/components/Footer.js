...
import iconphone from "../assets/img/footer/phoneicon.png";
...
const Footer = () => {
  return (
    ...
    <section class="footer">
      <div class="footer__container">
        ...
        <div class="footer__top">
          ...
          <div class="footer__top-col col-sm-4 ">
            <div class="footer__app-info">
              <span class="footer__service-lable">
            ...
            <div class="footer__app-badge">
              <a href="">
                <img src={chplay} width="120px" alt="" />
              </a>
              <a href="">
                <img src={appstore} width="120px" alt="" />
              </a>
            </div>
            <div class="footer__socsial-info">
              <div class="footer__app-info">
                <span class="app-info__label">THAM GIA CỘNG ĐỒNG</span>
                <span class="app-info__detail">
                  Cùng 2.5tr thành viên 30Shine
                </span>
              </div>
              <div class="footer__app-badge">
                <a href="">
        ...
        <div class="footer__bottom">
          <span class="copyright">
            Copyright 2022 30Shine, Inc. All Rights Reserved
          </span>
      ...
      {/* tag a phone */}
      <a href="tel:1800282830" className="footer__call-btn">
        <span className="icon__phone">
          <img class="icon__phone-img" src={iconphone} width="20px" alt="" />
        </span>
      </a>
    </section>
  );
